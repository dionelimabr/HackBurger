...
const CHALLENGE_META: Record<string, { title: string; description: string; category: string }> = {
  ...
  loginMcSafeSearchChallenge:       { title: 'Login DJ Trovão',             category: 'Security Misconfiguration', description: 'Faça login como DJ Trovão sem saber a senha (OSINT nas letras de rap).' },
  ...
  bjoernFavoritePetChallenge:       { title: 'Pet Favorito de Caio',        category: 'Security Misconfiguration', description: 'Resete a senha de Caio Andrade respondendo sua pergunta secreta.' },
  ...
  gdprDataErasureChallenge:         { title: 'LGPD Data Erasure',          category: 'Miscellaneous',          description: 'Faça login como um usuário que solicitou exclusão via LGPD.' },
  loginAmyChallenge:                { title: 'Login Ana Carolina',         category: 'SQLi',                  description: 'Faça login como Ana Carolina via SQL injection.' },
  loginBenderChallenge:             { title: 'Login Roberto Mota',         category: 'SQLi',                  description: 'Faça login como Roberto Mota via SQL injection.' },
  loginJimChallenge:                { title: 'Login Lucas Faria',          category: 'SQLi',                  description: 'Faça login como Lucas Faria via SQL injection.' },
  ...
  resetJimPasswordChallenge:        { title: 'Reset Senha de Lucas',       category: 'Security Misconfiguration', description: 'Resete a senha de Lucas Faria respondendo sua pergunta secreta.' },
  ...
  loginBjoernChallenge:             { title: 'Login Caio Andrade',         category: 'Security Misconfiguration', description: 'Faça login como Caio Andrade sem força bruta ou SQLi.' },
  loginUvoginChallenge:             { title: 'Login Viktor Sousa',         category: 'Security Misconfiguration', description: 'Faça login como Viktor Sousa decifrando o hash da senha.' },
  ...
  changeBenderPasswordChallenge:    { title: 'Trocar Senha do Roberto',    category: 'Broken Access Control',  description: 'Mude a senha de Roberto Mota sem conhecer a senha atual.' },
  ...
  resetBjoernPasswordChallenge:     { title: 'Reset Senha de Caio',        category: 'Security Misconfiguration', description: 'Resete a senha de Caio Andrade explorando recuperação fraca.' },
  resetMortyPasswordChallenge:      { title: 'Reset Senha de Gabriel',     category: 'Security Misconfiguration', description: 'Resete a senha de Gabriel Stein via OSINT.' },
  ...
  loginSupportTeamChallenge:        { title: 'Login Suporte HackBurger',   category: 'Security Misconfiguration', description: 'Faça login como Suporte HackBurger usando credenciais do log vazado.' },
