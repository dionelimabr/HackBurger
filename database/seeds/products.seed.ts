...
const products = [
  // Clássicos
  {
    ...
    price: 32.90,
    image_url: '/assets/images/burgers/classic-burger.jpg',
    rating: 4.8,
    rating_count: 320,
  ...
  },
  {
    ...
    price: 42.90,
    image_url: '/assets/images/burgers/cheeseburger-duplo.jpg',
    rating: 4.7,
    rating_count: 215,
  ...
  // Especiais
  {
    ...
    price: 49.90,
    image_url: '/assets/images/burgers/black-sheep.jpg',
    rating: 4.5,
    rating_count: 188,
  ...
  },
  {
    ...
    price: 52.90,
    image_url: '/assets/images/burgers/ultimate-bacon.jpg',
    rating: 4.6,
    rating_count: 302,
  ...
  // Frangos
  {
    ...
    price: 38.90,
    image_url: '/assets/images/burgers/crispy-chicken.jpg',
    rating: 5.0,
    rating_count: 410,
  ...
  // Veganos
  {
    ...
    price: 44.90,
    image_url: '/assets/images/burgers/vegan-burger.jpg',
    rating: 4.3,
    rating_count: 97,
  ...
  // Combos
  {
    ...
    price: 49.90,
    image_url: '/assets/images/burgers/combo-classic.jpg',
    rating: 4.9,
    rating_count: 560,
